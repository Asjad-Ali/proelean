                ...
                <table class="table table-bordered">
                  ...
                  <tbody>
                    ...
                    >
                      ...
                      <td>{{ job.budget }}</td>
                      <td>
                        <button class="btn btn-sm btn-success">{{ job.total_offers }}</button>
                      </td>
                      <td>
                        <button class="btn btn-sm btn-success" @click="deleteJob(job.id)">Delete</button>
                        </td>
                    </tr>
                  </tbody>
                </table>
