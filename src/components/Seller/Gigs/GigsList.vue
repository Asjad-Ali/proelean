<template>
  <div class="container-xl">
    <div class="row g-3 mb-4 align-items-center justify-content-between">
      <div class="col-auto">
        <h1 class="app-page-title mb-0">My Gigs</h1>
      </div>
      <div class="col-auto">
    ...
    <div class="row g-4">
        ...
        <div class="app-card app-card-doc shadow-sm h-100">
          <div class="app-card-thumb-holder p-3">
            <div class="app-card-thumb">
              <img
                class="thumb-image"
                src="/assets/seller/images/doc-thumb-1.jpg"
                alt=""
              />
            </div>
            <a class="app-card-link-mask" href="#file-link"></a>
      ...
      <div class="col-6 col-md-4 col-xl-3 col-xxl-2">
        <div class="app-card app-card-doc shadow-sm h-100">
          ...
          <div class="app-card-body p-3 has-card-actions">
            <h4 class="app-doc-title truncate mb-0">
              <a href="#file-link">Sed eleifend non libero congue fringilla</a>
            </h4>
            <div class="app-doc-meta">
              <ul class="list-unstyled mb-0">
                <li><span class="text-muted">Type:</span> Text</li>
        ...
        <div class="app-card app-card-doc shadow-sm h-100">
          <div class="app-card-thumb-holder p-3">
            <div class="app-card-thumb">
              <img
                class="thumb-image"
                src="/assets/seller/images/doc-thumb-2.jpg"
                alt=""
              />
            </div>
            <a class="app-card-link-mask" href="#file-link"></a>
