            ...
            <div class="row">
               <div class="col-lg-3 left">
                  <div class="box shadow-sm mb-3 rounded bg-white ads-box text-center">
                     <img src="/assets/images/job1.png" class="img-fluid" alt="Responsive image">
                  ...
                  <div class="box mb-3 shadow-sm rounded bg-white profile-box text-center">
                     <div class="p-5">
                        <img src="/assets/images/clogo2.png" class="img-fluid" alt="Responsive image">
                     </div>
               ...
               <div class="col-lg-9 right">
                  <div class="box shadow-sm rounded bg-white mb-3">
                     ...
                     <div class="box-body p-0">
                        ...
                        <div class="p-3 d-flex align-items-center osahan-post-header">
                           <div class="dropdown-list-image mr-3">
                              <img class="rounded-circle" src="/assets/images/user/s1.png" alt="">
                           </div>
                           <div class="font-weight-bold mr-3">
                  ...
                  <div class="box shadow-sm rounded bg-white mb-3">
                     ...
                     <div class="box-body p-0">
                        ...
                        <div class="p-3 d-flex align-items-center border-bottom osahan-post-header">
                           <div class="dropdown-list-image mr-3">
                              <img class="rounded-circle" src="/assets/images/user/s7.png" alt="">
                           </div>
                           <div class="font-weight-bold mr-3">
                        ...
                        <div class="p-3 d-flex align-items-center border-bottom osahan-post-header">
                           <div class="dropdown-list-image mr-3">
                              <img class="rounded-circle" src="/assets/images/user/s8.png" alt="">
                           </div>
                           <div class="font-weight-bold mr-3">
                              <div>
                        ...
                        <div class="p-3 d-flex align-items-center border-bottom osahan-post-header">
                           <div class="dropdown-list-image mr-3">
                              <img class="rounded-circle" src="/assets/images/user/s10.png" alt="">
                           </div>
                           <div class="font-weight-bold mr-3">
                              <div class="mb-2"><span class="font-weight-normal">Congratulate Gurdeep Singh Osahan (iamgurdeeposahan)</span>  for 5 years at Askbootsrap Pvt.
                              </div>
                        ...
                        <div class="p-3 d-flex align-items-center osahan-post-header">
                           <div class="dropdown-list-image mr-3">
                              <img class="rounded-circle" src="/assets/images/user/s9.png" alt="">
                           </div>
                           <div class="font-weight-bold mr-3">
                              <div>
                                 <span class="font-weight-normal">Congratulate Mnadeep singh (iamgurdeeposahan)</span>  for 4 years at Askbootsrap Pvt.
