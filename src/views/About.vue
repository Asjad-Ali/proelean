<template>
       <!-- Inner Header -->
      <section class="py-5  inner-header super-bg">
         <div class="container">
            <div class="row">
               <div class="col-md-12 text-left">
                  <h1 class="mt-0 mb-3 text-white">About Us</h1>
                  <div class="breadcrumbs padding-bottom">
         ...
         <div class="container">
            <div class="row align-items-center">
               <div class=" col-lg-6 col-md-6 ">
                  <img class="rounded img-fluid" src="/assets/images/Pro-eLean-business.jpg" alt="Card image cap">
               </div>
               <div class="col-lg-6 col-md-6  ">
               <h5 class="mt-4 orange-color">OUR VISION</h5>
                  <h2 class="mb-5">Application and web platform for everyone.</h2>
                  
                  <p class='about-paragraph'>Diam vestibulum tristique non purus velit dictum vel aliquam id egestas odio tortor volutpat nulla varius aliquam vulputate commodo mus volutpat pretium, quam hendrerit enim aliquam nisl imperdiet</p>
               </div>
            </div>
         </div>
      </section>
      <!-- End About 1-->
         ...
         <div class="container">
            <div class="row align-items-center">
               ...
               <div class="col-lg-6 col-md-6  ">
               <h5 class="mt-4 orange-color">OUR MISSION</h5>
                  <h2 class="mb-5">Easy. Fun. Make money. Save money. Enjoy.</h2>
               ...
               <div class=" col-lg-6 col-md-6 ">
                  <img class="rounded img-fluid" src="/assets/images/Pro-eLean--freelancer business.jpg" alt="Card image cap">
               </div>
            </div>
         </div>
      </section>
      ...
      <!-- End What We Provide -->
      <!-- Trusted Agents -->
      <section class="py-5 bg-white border-for-bottom">
         <div class="section-title text-center mb-5">
            <h2>Our Pro eLean Team</h2>
            <!-- <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit.</p> -->
         </div>
         <div class="container">
            <div class="row">
               <div class="col-lg-4 col-md-4">
                  <div class="agents-card text-center">
                     <img class="img-fluid mb-4" src="/assets/images/user/s1.png" alt="">
                     <!-- <p class="mb-4">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been.</p> -->
                     <h6 class="mb-0 text-success">- Tanja</h6>
                     <!-- <small>Buying Agent</small> -->
                  </div>
               </div>
               <div class="col-lg-4 col-md-4">
                  <div class="agents-card text-center">
                     <img class="img-fluid mb-4" src="/assets/images/user/s2.png" alt="">
                     <!-- <p class="mb-4">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been.</p> -->
                     <h6 class="mb-0 text-success">- Ville</h6>
                     <!-- <small>Selling Agent</small> -->
                  </div>
               </div>
               <div class="col-lg-4 col-md-4">
                  <div class="agents-card text-center">
                     <img class="img-fluid mb-4" src="/assets/images/user/s3.png" alt="">
                     <!-- <p class="mb-4">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been.</p> -->
                     <h6 class="mb-0 text-success">- Kalle</h6>
