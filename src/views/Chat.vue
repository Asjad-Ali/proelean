                           ...
                           <div class="osahan-chat-left">
                              ...
                              <div class="osahan-chat-list">
                                 <div class="p-3 d-flex align-items-center border-bottom osahan-post-header overflow-hidden">
                                    <div class="dropdown-list-image mr-3"><img class="rounded-circle" src="/assets/images/user/s1.png" alt=""></div>
                                 ...
                                 <div class="p-3 d-flex align-items-center bg-light border-left border-primary  border-bottom osahan-post-header overflow-hidden">
                                    <div class="dropdown-list-image mr-3"><img class="rounded-circle" src="/assets/images/user/s2.png" alt=""></div>
                                    <div class="font-weight-bold mr-1 overflow-hidden">
                                 ...
                                 <div class="p-3 d-flex align-items-center border-bottom osahan-post-header overflow-hidden">
                                    <div class="dropdown-list-image mr-3"><img class="rounded-circle" src="/assets/images/user/s3.png" alt=""></div>
                                    <div class="font-weight-bold mr-1 overflow-hidden">
                                 ...
                                 <div class="p-3 d-flex align-items-center border-bottom osahan-post-header overflow-hidden">
                                    <div class="dropdown-list-image mr-3"><img class="rounded-circle" src="/assets/images/user/s4.png" alt=""></div>
                                    <div class="font-weight-bold mr-1 overflow-hidden">
                                 ...
                                 <div class="p-3 d-flex align-items-center border-bottom osahan-post-header overflow-hidden">
                                    <div class="dropdown-list-image mr-3"><img class="rounded-circle" src="/assets/images/user/s5.png" alt=""></div>
                                    <div class="font-weight-bold mr-1 overflow-hidden">
                                       <div class="text-truncate">Carl Jenkins
                                       </div>
                                       <div class="small text-truncate overflow-hidden text-black-50"><i class="mdi mdi-check"></i> Semper ex diam, at tristique ipsum varius sed. Pellentesque non metus ullamcorper</div>
                                 ...
                                 <div class="p-3 d-flex align-items-center border-bottom osahan-post-header overflow-hidden">
                                    <div class="dropdown-list-image mr-3"><img class="rounded-circle" src="/assets/images/user/s6.png" alt=""></div>
                                    <div class="font-weight-bold mr-1 overflow-hidden">
                                       <div class="text-truncate">Bertha Martin
                                       </div>
                                       <div class="small text-truncate overflow-hidden text-black-50"><i class="mdi mdi-check text-primary"></i> Pellentesque semper ex diam, at tristique ipsum varius sed. Pellentesque non metus ullamcorper</div>
                                 ...
                                 <div class="p-3 d-flex align-items-center border-bottom osahan-post-header overflow-hidden">
                                    <div class="dropdown-list-image mr-3"><img class="rounded-circle" src="/assets/images/user/s7.png" alt=""></div>
                                    <div class="font-weight-bold mr-1 overflow-hidden">
                                       <div class="text-truncate">Bertha Martin
                                       </div>
                                       <div class="small text-truncate overflow-hidden text-black-50"><i class="mdi mdi-check text-primary"></i> Pellentesque semper ex diam, at tristique ipsum varius sed. Pellentesque non metus ullamcorper</div>
                                 ...
                                 <div class="p-3 d-flex align-items-center border-bottom osahan-post-header overflow-hidden">
                                    <div class="dropdown-list-image mr-3"><img class="rounded-circle" src="/assets/images/user/s8.png" alt=""></div>
                                    <div class="font-weight-bold mr-1 overflow-hidden">
                                       <div class="text-truncate">Stacie Hall
                                       </div>
                                       <div class="small text-truncate overflow-hidden text-black-50"><i class="mdi mdi-check"></i> Semper ex diam, at tristique ipsum varius sed. Pellentesque non metus ullamcorper</div>
                                 ...
                                 <div class="p-3 d-flex align-items-center border-bottom osahan-post-header overflow-hidden">
                                    <div class="dropdown-list-image mr-3"><img class="rounded-circle" src="/assets/images/user/s9.png" alt=""></div>
                                    <div class="font-weight-bold mr-1 overflow-hidden">
                                       <div class="text-truncate">Carl Jenkins
                                       </div>
                                       <div class="small text-truncate overflow-hidden text-black-50"><i class="mdi mdi-check"></i> Semper ex diam, at tristique ipsum varius sed. Pellentesque non metus ullamcorper</div>
                        ...
                        <div class="col-lg-7 col-xl-8 px-0">
                           ...
                           <div class="osahan-chat-box p-3 border-top border-bottom bg-light">
                              ...
                              <div class="d-flex align-items-center osahan-post-header">
                                 <div class="dropdown-list-image mr-3 mb-auto"><img class="rounded-circle" src="/assets/images/user/s1.png" alt=""></div>
                                 <div class="mr-1">
                              ...
                              <div class="d-flex align-items-center osahan-post-header">
                                 <div class="dropdown-list-image mr-3 mb-auto"><img class="rounded-circle" src="/assets/images/user/s2.png" alt=""></div>
                                 <div class="mr-1">
               ...
               <aside class="col col-xl-3 order-xl-2 col-lg-12 order-lg-2 col-12">
                  ...
                  <div class="box shadow-sm mb-3 rounded bg-white ads-box text-center">
                     <div class="image-overlap-2 pt-4">
                        <img src="/assets/images/l3.png" class="img-fluid rounded-circle shadow-sm" alt="Responsive image">
                        <img src="/assets/images/user/s8.png" class="img-fluid rounded-circle shadow-sm" alt="Responsive image">
                     </div>
