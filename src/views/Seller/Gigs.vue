            ...
            <div class="row">
               <div class="col-md-12">
                  <div class="d-flex align-items-center mb-3 pb-3 border-bottom">
                     ...
                     <router-link class="btn btn-sm btn-success ml-auto light" 
                     ...
                     <div class="tab-pane active" id="active">
                        <div class="table-responsive box-table mt-3">
                           <table class="table table-bordered">
                              ...
                              <tbody>
                                 <tr v-for="service in $store.getters.getUserServices" :key="service.key">
                                    <td>
                                       <a href="#" class="make-black">
                                          <img class="order-proposal-image" :src="service.service_media.media">
                                          <p class="order-proposal-title">{{ service.s_description }}</p>
                                       </a>
                                    </td>
                                    <td>March 23, 2021</td>
                                    <td>March 24, 2021</td>
