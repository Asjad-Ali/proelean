              ...
              <form class="settings-form">
                <div class="mb-3">
                  <label for="setting-input-1" class="form-label"
                    >Enter Your Title<span class="text-danger">*</span>
                    <span
                      class="text-danger"
                ...
                <div class="mb-3">
                  <label for="setting-input-2" class="form-label"
                    >Describe Your services<span class="text-danger">*</span>
                    <span
                      class="text-danger"
                ...
                <div class="mb-3">
                  <div class="row">
                    ...
                    <div class="form-group col-md-6">
                      <label for="setting-input-2" class="form-label"
                        >What is your budget for this service?<span class="text-danger">*</span>
                        <span
                          class="text-danger"
                ...
                <div class="mb-3">
                  <div class="row">
                    <div class="form-group col-md-6">
                      <label for="setting-input-2" class="form-label"
                        >No of Revisions<span class="text-danger">*</span>
                        <span
                          class="text-danger"
                ...
                <div class="mb-3">
                  ...
                  <div class="form-group">
                    <textarea
                      ...
                      name="description"
                      rows="4"
                      placeholder="Add additional info About Your Service"
                      required
                    ></textarea>
                  </div>
                </div>
